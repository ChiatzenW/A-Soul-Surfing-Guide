...
你可以点击 GitHub 上方 
[issues](https://github.com/A-Soul-Guide/A-Soul-Surfing-Guide/issues) 
页面，点击右边的 New issues 绿色按钮。在弹出的新菜单中，
选择新条目选项，你会看到一个页面编辑框，请在标题的
“【新条目】” 后方空一格，填写你要补充的内容名字。

然后请不要删除 `****` 里面的内容，你只需要修改每个小标
题底下的解释文字就可以了。
